...
" F6: Add a fortune from the 'fortune' program
" mX			mark where we are
" G			go to the last line
" A<CR><CR><Esc>	add two empty lines
" i--<CR><Esc>		insert '--'
" !!fortune<CR>		insert text from 'fortune' program
" `X			return to where we started

map <F6> mXGA<CR><CR><Esc>i--<CR><Esc>!!fortune<CR>`X
